...
单套件：`cd agent/extensions/<ext> && ./node_modules/.bin/vitest run`（pi-web-search 75 / pi-memory 90 / pi-autopilot 97 / pi-browser 24 / pi-context 73 / plan-mode 69 / pi-tmux 19 / pi-voice 128 / pi-link 57 用例，2026-08-15 实测，以 test-all.sh 输出为准）
